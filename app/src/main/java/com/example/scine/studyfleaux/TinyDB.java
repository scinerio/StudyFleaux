...
public class TinyDB {
    ...
    public ArrayList<FlashcardSet> getListObject(String key, Class<?> mClass){
    	Gson gson = new Gson();

    	ArrayList<String> objStrings = getListString(key);
    	ArrayList<FlashcardSet> objects =  new ArrayList<FlashcardSet>();

    	for(String jObjString : objStrings){
    		Object value  = gson.fromJson(jObjString,  mClass);
    		objects.add((FlashcardSet) value);
    	}
    	return objects;
    }
   ...
   public void putListObject(String key, ArrayList<FlashcardSet> objArray){
   	checkForNullKey(key);
   	Gson gson = new Gson();
